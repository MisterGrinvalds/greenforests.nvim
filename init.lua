...
vim.o.number = true
-- Relative line numbers help with jump motions (e.g., 5j, 12k)
...
-- Works with :checktime to detect external modifications
vim.o.autoread = true
...
--  NOTE: Ctrl+hjkl is handled by smart-splits.nvim plugin
--  It works seamlessly with tmux/wezterm/kitty panes
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    -- Highlighting/indentation is now handled by Neovim core, not the plugin
    config = function()
